        ...
        def manage_tasks(params)
          ...
          when :create
            begin
              ...
              x = Mnemosyne.db.execute 'INSERT INTO tasks (title, plan, updates, status, current_step, workflow_type, parent_task_id, owner, seal_id, milestone_order) VALUES ' \
                             '(?,?,?,?,?,?,?,?,?,?)', [params[:title], params[:plan], '[]', 'pending', 0, workflow_type, parent_task_id, params[:owner], params[:seal_id], params[:milestone_order]]
              { 'ok' => true,
                ...
                milestone_order: params[:milestone_order] }
